...
class MyProfileController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        $validated = $request->validate([
            "username" => [
                "required",
                //cela permet de s'assurer que le nom d'utilisateur ne contient que des lettres, des chiffres, des tirets et des underscores, et qu'il est composé de caractères ASCII (pour éviter les problèmes d'encodage)
                "alpha_dash:ascii",
                "min:2",
                "max:255",
                //cela permet de s'assurer que le nom d'utilisateur est unique dans la table "users", mais ignore l'utilisateur actuel (pour permettre à l'utilisateur de conserver son nom d'utilisateur actuel s'il ne le change pas)
