...
return [
    ...
    "gt" => [
        "array" =>
            "Le tableau :attribute doit contenir plus de :value éléments.",
        "file" =>
    ...
    "gte" => [
        "array" =>
            "Le tableau :attribute doit contenir au moins :value éléments.",
        "file" =>
        ...
        "string" =>
            "Le texte :attribute doit contenir au moins :value caractères.",
    ],
    "hex_color" =>
    ...
    "lt" => [
        "array" =>
            "Le tableau :attribute doit contenir moins de :value éléments.",
        "file" =>
            "La taille du fichier de :attribute doit être inférieure à :value kilo-octets.",
        "numeric" => "La valeur de :attribute doit être inférieure à :value.",
        "string" =>
            "Le texte :attribute doit contenir moins de :value caractères.",
    ],
    "lte" => [
        "array" =>
            "Le tableau :attribute doit contenir au plus :value éléments.",
        "file" =>
        ...
        "string" =>
            "Le texte :attribute doit contenir au plus :value caractères.",
    ],
    ...
    "min" => [
        "array" =>
            "Le tableau :attribute doit contenir au moins :min éléments.",
        "file" =>
