<x-default-layout>
    ...
    <form method="POST" action="{{ url('/posts/' . $post->id) }}">
        ...
        {{-- Cette méthode permet de rediriger vers la méthode update() du controller, même si derrière les décors c'est une méthode POST --}}
        @method('PATCH')
        ...
        <footer class="pt-4 border-t border-gray-200 dark:border-gray-700">
            <div class="flex items-center justify-between">
                <div class="flex gap-2">
                    ...
                    <button type="submit" form="delete-post-form" onclick="return confirm('{{ __('ui.posts.form.actions.delete_confirm') }}')" class="px-4 py-2 bg-red-600 dark:bg-red-900 text-white rounded-md hover:bg-red-700 dark:hover:bg-red-800 cursor-pointer">
